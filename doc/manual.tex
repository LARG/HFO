...
Self velocity invalid   & N  &  Y? &  Y? &  Y? & ?  &  N  &  ?  &  N? & N? & ?  & ?  &  Y   & Y  &  N  &  N   & N  &  N \\
Ball position invalid   & Y  &  Y  &  Y? &  N  & N  &  Y  &  N? &  N  & ?  & N  & N  &  Y?  & N  &  N  &  N   & N  &  N \\
Ball velocity invalid   & Y  &  Y  &  Y  &  ?  & ?  &  Y  &  ?  &  N? & ?  & N  & N? &  Y?  & Y? &  Y  &  Y   & Y  &  Y \\
Teammate loc invalid    & Y  &  Y  &  Y  &  Y  & Y  &  Y  &  Y  &  Y  & ?  & Y  & N  &  Y?  & Y  &  Y  &  Y   & Y  &  Y \\
Team. unum invalid      & Y  &  Y  &  Y  &  Y  & Y  &  Y  &  Y  &  Y  & Y  & Y  & N  &  Y   & Y  &  Y  &  Y   & Y  &  Y \\
Opponent loc invalid    & Y  &  Y  &  Y  &  Y  & Y  &  Y  &  Y? &  Y  & ?  & Y? & Y  &  Y?  & Y  &  Y  &  Y   & Y  &  N \\
...
\end{center}
*: The Move command is not recommended for offensive players able to kick the ball, but can work for defensive players (triggering a tackle).\\
\begin{itemize}[noitemsep]
